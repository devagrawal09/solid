// Solid 2 port of frameworks/keyed/solid/src/main.jsx (JFB f2df01a8).
// Differences are only the Solid 2 API renames:
//   createSelector  -> createProjection (the documented migration, 04-stores.md)
//   batch(...)      -> removed (Solid 2 batches writes until the next flush)
//   solid-js/web    -> @solidjs/web
//   <For> children  -> default (keyed) For receives the raw item, as in 1.x
